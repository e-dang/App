...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "tracker.utils.context_processors.settings_context",
            ],
        },
    }
]
...
REST_AUTH_SERIALIZERS = {
    "LOGIN_SERIALIZER": "tracker.users.serializers.LoginSerializer",
    "USER_DETAILS_SERIALIZER": "tracker.users.serializers.UserSerializer",
    "PASSWORD_RESET_SERIALIZER": "tracker.users.serializers.PasswordResetSerializer",
}

REST_AUTH_REGISTER_SERIALIZERS = {
    "REGISTER_SERIALIZER": "tracker.users.serializers.RegisterSerializer",
}
