...
import pytest
from tracker.tests.assertions import assert_field_error
from tracker.users.serializers import RegisterSerializer
...
class TestRegisterSerializer:
    def test_get_cleaned_data_returns_dict_with_correct_fields(self, user_json: Dict) -> None:
    ...
    def test_get_cleaned_data_returns_empty_string_for_name_when_name_not_provided(self, user_json: Dict) -> None:
        user_json.pop("name")
        serializer = RegisterSerializer(data=user_json)
