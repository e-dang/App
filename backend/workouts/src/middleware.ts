...
export const validateIsOwner = (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
...
export const validateIsAdmin = (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
